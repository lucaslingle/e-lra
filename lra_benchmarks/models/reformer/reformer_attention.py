...
def lsh_attention_single_head(
    query, value, n_buckets, n_hashes, causal_mask=True, length_norm=False
):
    ...
    buckets = hash_vectors(query, rng, num_buckets=n_buckets, num_hashes=n_hashes)
