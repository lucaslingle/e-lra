...
_ATTENTION_FNS = {
    "dot_product": lambda qkv_dim, unidirectional=False: nn.dot_product_attention,
    "softmax": performer_attention.make_fast_softmax_attention,
    "generalized": performer_attention.make_fast_generalized_attention,
}
...
def _make_attention_fn(attention_fn_cls, attention_fn_kwargs=None):
    ...
    return (
        ...
        else functools.partial(attention_fn, **attention_fn_kwargs)
    )
