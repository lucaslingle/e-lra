...
class AddPositionEmbs(nn.Module):
    ...
    def apply(
        self, inputs, inputs_positions=None, max_len=512, posemb_init=None, cache=None
    ):
...
def classifier_head_dual(
    encoded1, encoded2, num_classes, mlp_dim, pooling_mode="MEAN", interaction=None
):
