...
flags.DEFINE_string("task", default="basic", help="Name of task to create.")
flags.DEFINE_integer("num_train_samples", default=96000, help="Num train samples.")
flags.DEFINE_integer("num_valid_samples", default=2000, help="Num test samples.")
flags.DEFINE_integer("num_test_samples", default=2000, help="Number of test samples.")
flags.DEFINE_integer("max_depth", default=10, help="max tree depth of train seqs.")
flags.DEFINE_integer("max_args", default=10, help="max num args per op in train seqs.")
flags.DEFINE_integer("max_length", default=2000, help="max len per train seq.")
flags.DEFINE_integer("min_length", default=500, help="min len per train seq.")
flags.DEFINE_string("output_dir", default="output_dir", help="Dir to output files.")
...
def main(argv):
    ...
    data = set()
    num_samples = (
        FLAGS.num_train_samples + FLAGS.num_test_samples + FLAGS.num_valid_samples
    )
